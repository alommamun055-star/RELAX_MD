...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || getConfig("BOT_NAME") || "RELAX_MD",  // Bot's display name
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "918116539293",  // Owner's WhatsApp number
    OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "⤹𝐗 𝐑𝐎𝐌𝐄𝐎𓂃༊",           // Owner's name
    DEV: process.env.DEV || "918116539293",                     // Developer's contact number
    DEVELOPER_NUMBER: '918116539293@s.whatsapp.net',            // Developer's WhatsApp ID
    ...
    STICKER_NAME: process.env.STICKER_NAME || "⤹𝐗 𝐑𝐎𝐌𝐄𝐎𓂃༊",     // Sticker pack name
    ...
    DESCRIPTION: process.env.DESCRIPTION || "*© CREATER ⤹𝐗 𝐑𝐎𝐌𝐄𝐎𓂃༊ *",  // Bot description
